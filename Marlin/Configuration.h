...
#define STRING_CONFIG_H_AUTHOR "(Dust, Ender-3 TROLLER)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 TROLLER"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -27.5, -31.4, 0 }
